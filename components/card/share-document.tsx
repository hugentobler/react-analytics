...
export function DemoShareDocument() {
  return (
    <Card data-ui-component="Card" data-ui-variant="Share Document">
      <CardHeader>
      ...
      <CardContent>
        <div className="flex space-x-2">
          <Input value="http://example.com/link/to/document" readOnly data-ui-action="Input" />
          <Button variant="secondary" className="shrink-0" data-ui-action="Copy Link">
            Copy Link
          </Button>
        </div>
