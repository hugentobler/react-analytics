...
export default function SlideOver({ openSlideOver, onSlideOverClose }: { openSlideOver: boolean, onSlideOverClose: () => void }) {
  const [open, setOpen] = useState(false)

  useEffect(() => {
    setOpen(openSlideOver)
  }, [openSlideOver])

  const handleCloseSlideOver = () => {
    setOpen(false)
    onSlideOverClose() // Call the callback function provided by the parent component
  }

  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={handleCloseSlideOver}>
        ...
        <div className="fixed inset-0 overflow-hidden">
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-lg" data-ui-component="Slide Over">
